...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-neutral-50">
        <div class="min-h-screen">
            <!-- Navigation -->
            <nav class="backdrop-blur-md bg-white/80 shadow-lg rounded-b-2xl border-b border-neutral-200 sticky top-0 z-50 glass-navbar">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="flex-shrink-0 flex items-center">
                                <a href="{{ route('home') }}" class="flex items-center space-x-2">
                                    <img src="https://cdn-icons-png.flaticon.com/512/2436/2436874.png" alt="LearnPath Logo" class="h-8 w-8 drop-shadow-md">
                            ...
                            <div class="hidden space-x-6 sm:ml-10 sm:flex">
                                <a href="{{ route('courses.index') }}" class="nav-link transition-all duration-200 rounded-lg px-3 py-2 hover:bg-primary-50 hover:text-primary-700 focus:bg-primary-100 focus:text-primary-800">
                                    <svg class="h-5 w-5 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                    </svg>
                                    Courses
                                </a>
                                <a href="{{ route('paths.index') }}" class="nav-link transition-all duration-200 rounded-lg px-3 py-2 hover:bg-accent-50 hover:text-accent-700 focus:bg-accent-100 focus:text-accent-800">
                                    <svg class="h-5 w-5 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6 space-x-4">
                            @auth
                                ...
                                <div class="relative mr-2" x-data="{ open: false }" @click.away="open = false">
                                    <button class="p-1 rounded-full text-neutral-600 hover:text-primary-600 focus:outline-none relative">
                                ...
                                <div class="relative" x-data="{ open: false }" @click.away="open = false">
                                    <button @click="open = !open" 
                                            class="flex items-center space-x-2 text-sm font-medium text-neutral-600 hover:text-primary-600 focus:outline-none transition-colors rounded-lg px-2 py-1 bg-white/70 shadow-sm">
                                        <img class="h-8 w-8 rounded-full object-cover border-2 border-primary-200 shadow" 
                                    ...
                                    <div x-show="open" 
                                         ...
                                         class="absolute right-0 w-56 mt-2 py-3 bg-white/90 rounded-xl shadow-2xl border border-neutral-100 backdrop-blur-lg">
                                        <div class="px-4 pb-2 border-b border-neutral-100 mb-2">
                                            <div class="flex items-center space-x-2">
                                                <img class="h-10 w-10 rounded-full object-cover border border-primary-200" src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=0284c7&color=fff" alt="{{ Auth::user()->name }}">
                                                <div>
                                        ...
                                        <a href="{{ route('profile.show') }}" class="block px-4 py-2 text-sm text-neutral-700 hover:bg-primary-50 rounded-lg flex items-center">
                                            <svg class="h-4 w-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                            </svg>
                                            Profile
                                        </a>
                                        <a href="{{ route('dashboard') }}" class="block px-4 py-2 text-sm text-neutral-700 hover:bg-accent-50 rounded-lg flex items-center">
                                            <svg class="h-4 w-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <button type="submit" class="block w-full text-left px-4 py-2 text-sm text-neutral-700 hover:bg-red-50 rounded-lg flex items-center">
                                                <svg class="h-4 w-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            @else
                                <a href="{{ route('login') }}" class="btn-secondary rounded-lg px-4 py-2">Log in</a>
                                <a href="{{ route('register') }}" class="btn-primary rounded-lg px-4 py-2">Register</a>
                            @endauth
                        </div>

                        <!-- Mobile menu button -->
                        <div class="flex items-center sm:hidden">
                            <button type="button" @click="open = !open" class="text-neutral-600 hover:text-primary-600 focus:outline-none rounded-lg p-2 bg-white/70 shadow">
